...
type Pager struct {
	...
	Order        int    `json:"order" form:"order" url:"order" binding:"oneof=0 1 2 3"`              // 已定义字段排序
	OrderByField string `json:"order_by_field" form:"order_by_field" url:"order_by_field"`           // 自定义字段排序
