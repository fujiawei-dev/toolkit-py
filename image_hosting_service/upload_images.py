...
upload_url = "https://image.kieng.cn/upload.html?type=%s"
server_types = ['jd', 'sg', 'wy']
...
def upload_image(path: str):
    ...
    if os.path.isfile(path):
        ...
        for server_type in server_types:
            res = requests.post(upload_url % server_type, headers=headers, files=files).json()
        ...
        success_list.append(res.get('msg', ''))
...
if __name__ == '__main__':
    ...
    # upload_image(
    #     r'D:\OneDrive\Repositories\stock-notes\content\posts\daily\images\2021\8\Screenshot_20210803-171456.png')
    # print(success_list)
